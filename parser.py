...
def parser():
    ...
    cipher_parser.add_argument('input_file', help='Enter the name of file with text to encrypt/decrypt',
                               default=sys.stdin)
    cipher_parser.add_argument('--output_file', help='Enter the name of file to put the encrypted/decrypted text',
                               default=sys.stdout)
